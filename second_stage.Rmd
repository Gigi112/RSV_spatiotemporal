...
beta1.nj <- beta1/sd.nj.hs
hs.nj.90th <- quantile(NJcovariates$hs,0.9)-mean.nj.hs
hs.nj.10th <- quantile(NJcovariates$hs,0.1)-mean.nj.hs
beta0.nj <- beta0
...
mean(monthnj90th.hs-monthnj10th.hs)
quantile(monthnj90th.hs-monthnj10th.hs,c(0.025,0.975))
