...
saveRDS(firstct,"firstct.rds")  # save posterior estimates for the second stage model
...
saveRDS(firstnj,"firstnj.rds")  # save posterior estimates for the second stage model
